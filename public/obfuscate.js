 ...
 */
function obfuscateDistances(distances) {
    const obfuscated = {};
 ...
 */
function deobfuscateDistances(cache) {
    if (!cache) {
        return {};
    }
    const distances = {};
...
function loadDistances() {
    return deobfuscateDistances(getStoredItem('distances'));
}
...
export function storeDistances(distances) {
    distances = obfuscateDistances(distances);
