 ...
 *
 * @param {number} miles - A distance in miles
 * @returns {number} A distance in feet
 */
...
/**
 * Convert degrees to be greater than or equal to zero and less than 360.
 *
 * @param {number} An angle in degrees.
 * @returns {number} Degrees from zero to less than 360.
 */
