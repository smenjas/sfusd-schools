...
export default class HTMLTest {
    ...
    static renderDirectionsLink() {
        ...
        const url = `${prefix}3500%20Great%20Hwy%2C%2094132/1220%20Avenue%20M%2C%2094132`;
        const tests = [
    ...
    static renderList() {
        ...
        const unsafe = '<ul><li>Tom &amp; Jerry</li></ul>';
        const tests = [
            [[], ''],
            [[null], ''],
            [[0], ''],
    ...
    static renderMapLink() {
        ...
        const url = `${prefix}443%20Burnett%20Ave%2C%2094131`;
        const tests = [
