...
export default class TestTest {
    ...
    static compareMaps() {
        const tests = [
            ...
            [[ new Map(), new Map() ], true],
            [[ new Map(), {a: 1} ], false],
            [[ new Map([[1, 1]]), new Map() ], false],
            [[ new Map([[1, 1]]), new Map([[1, 1]]) ], true],
            [[ new Map([[1, 1]]), new Map([[1, 1], [2, 1]]) ], false],
            [[ new Map([[1, 1], [2, 1]]), new Map([[1, 1]]) ], false],
            [[ new Map([[1, 1]]), new Map([[1, 2]]) ], false],
            [[ new Map([[1, 1]]), new Map([[2, 1]]) ], false],
            [[ new Map([[1, []]]), new Map([[1, []]]) ], true],
            [[ new Map([[1, []]]), new Map([[2, []]]) ], false],
            [[ new Map([[1, [1]]]), new Map([[1, [1]]]) ], true],
            [[ new Map([[1, [1]]]), new Map([[1, [2]]]) ], false],
            [[ new Map([[1, new Map([[1, {}]])]]), new Map([[1, new Map([[1, {}]])]]) ], true],
            [[ new Map([[1, new Map([[1, {}]])]]), new Map([[2, new Map([[1, {}]])]]) ], false],
            [[ new Map([[1, new Map([[3, 1]])]]), new Map([[1, new Map([[3, 1]])]]) ], true],
            [[ new Map([[1, new Map([[3, 1]])]]), new Map([[1, new Map([[3, 2]])]]) ], false],
        ];

        return Test.run(Test.compareMaps, tests);
    }
